...
/**
 * Objetos de transferencia da API REST consumida pelo front-end.
 *
 * <p>A API nunca serializa entidades do dominio: alem de evitar o carregamento
 * tardio de associacoes, e aqui que os dados de custo sao omitidos para os perfis
 * sem acesso financeiro (RN007).</p>
 */
public final class RespostaDtos {
    ...
    /** Indicadores da tela inicial (RF12 e RN005). */
    ...
    /** Item de lista para preencher selecoes no front-end. */
    public record Opcao(String valor, String descricao) {
    }

    /** Mensagem de erro em portugues e em linguagem nao tecnica (RNF13). */
